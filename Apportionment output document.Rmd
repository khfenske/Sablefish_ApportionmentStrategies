...
par(mfrow=c(1,1))
plot(mgmtN~mgmt_rep_years, ylim=c(0,250),typ="l",lwd=3,col="red",ylab="Year",xlab="Abundance (millions)")
lines(simN_sum1[2:43]~OMyears,typ="l",lwd=3,col="black") 
...
OM recruitment was desined to match EM recruitment.
```{r, echo=FALSE}
