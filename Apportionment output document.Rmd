...
10 - All_to_one (all apportionment to one area - for research purposes of showing extremes ONLY)  
...
for(b in 1:n.apports){
  dir.temp <- paste0(dir.output,"/Apport.Option_",b)
AM_ofv[,,b] <- readRDS(file.path(dir.temp,"maxgrads.rds")) 
AM_sprpen[,,b] <- readRDS(file.path(dir.temp,"maxgrads.rds")) 
}
AM_ofv[44:n.year,,]
#AM_sprpen[44:n.year,,]
```
