...
Second, run Dana's apportionment R code to get the 'Status quo' apportionment (the ones not currently used for management). Use the output file 'appto verify the results from the 'status quo' function we are using here.
```{r}
current <- 2017
