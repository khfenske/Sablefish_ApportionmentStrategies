...
getwd()
#Survey
webareas<-read.csv("Web Areas.csv",header=T) #this is downloaded from AKFIN as csv and read in here
str(webareas)
...
fishcpue<-read.csv("fisheryCPUE17.csv",header=T) 
...
write.csv(d, "areafishrpw.csv")
write.csv(colSums(d),"fishrpw.csv")
average<-melt(a/b)
...
ggsave("fishcpue.png",height=5,width=7,dpi=300)
