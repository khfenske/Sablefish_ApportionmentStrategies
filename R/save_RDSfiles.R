...
#save the OM conditioning period things to the folder
saveRDS(ssb,"ssb.rds")
saveRDS(C.b,"C.b.rds" )
saveRDS(C.n,"C.n.rds" )
saveRDS(harvest.b,"harvest.b.rds")
saveRDS(OM_fixed_catch,"OM_fixed_catch.rds" )
saveRDS(OM_trawl_catch,"OM_trawl_catch.rds" )
saveRDS(temp.catchnumbiom,"temp.catchnumbiom.rds")
...
saveRDS(EM_F35, "EM_F35.rds")
saveRDS(EM_F40, "EM_F40.rds")
saveRDS(ABC_projection,"ABC_projection.rds")
