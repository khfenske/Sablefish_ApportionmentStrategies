...
re_apportionment <- function(ABC.total,n.areas,biom.data,biomass.cv.data) { #make up the cv stuff for now
  path<-getwd()
  setwd(paste0(path,"/re/"))
  biomass.years <- as.numeric(rownames(biom.data))#(rownames(biom.data))
  biomass.n.years <- nrow(biom.data)#nrow(biom.data)
...
re_apportionment(ABC.total,n.areas,biom.dataT,biomass.cv.test.data) #needed to transpose the data?
