...
#calculate the mean (or median?) length at 50% female maturity - 
#then calculate the proportion of females of that 
...
agebased_apportionment(ABC.total,n.area,test.data,L50_mat)
