...
create_sim_objects <- function() {
  ...
  OM_fixed_catch <<- matrix(nrow=n.year, ncol=n.sims, dimnames=list(years,sims)) #matrix to hold all of the OM fixed gear catch for initial population and simulated years
  OM_trawl_catch <<- matrix(nrow=n.year, ncol=n.sims, dimnames=list(years,sims)) #matrix to hold all of the OM trawl gear catch for initial population and simulated years
  OM_Surv.RPN <<- matrix(nrow=n.year, ncol=n.sims, dimnames=list(years,sims)) #matrix to hold all of the OM survey RPN data
